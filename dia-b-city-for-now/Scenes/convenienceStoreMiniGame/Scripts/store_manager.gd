...
func _setup_mini_game_manager():
	var mgr_scene = preload("res://Scenes/convenienceStoreMiniGame/Scripts/mini_game_manager.gd")
	var mgr = Node2D.new()
...
func _end_game():
	...
	var end_scr = preload("res://Scenes/convenienceStoreMiniGame/Scripts/end_screen.gd")
