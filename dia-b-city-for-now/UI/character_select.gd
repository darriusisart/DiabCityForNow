...
@onready var zayne_button = $CanvasLayer/Control/VBoxContainer/HBoxContainer2/ZayneButton
...
func _ready():
	...
	zayne_button.pressed.connect(_on_zayne_pressed)
	start_button.pressed.connect(_on_start_pressed)

	await get_tree().process_frame

	for button in [west_button, suki_button, beau_button, jodie_button, nia_button, leena_button, cas_button, zayne_button, start_button]:
...
func _on_zayne_pressed():
	selected_character = "zayne"
	selected_label.text = "Selected: Zayne"
	print("Selected Zayne")
...
func _on_zayne_button_mouse_entered() -> void:
	animate_button(zayne_button, HOVER_SCALE)


func _on_zayne_button_mouse_exited() -> void:
	animate_button(zayne_button, Vector2.ONE)
